...
| 6 | C5 | Contenido | Testing en el pipeline: unit tests, coverage y el umbral que frena un merge | [PDF](clases/Clase05/Clase05-presentacion.pdf) | *próximamente* | [TP5](trabajos/05-testing-calidad.md) | *próximamente* |
